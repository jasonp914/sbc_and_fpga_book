...
The most popular and most capable is the \ac{ARM} family of processors. The most popular \ac{SBC} is the \ac{RPi}. There are a few versions of the \ac{RPi} with slightly different \ac{ARM} processors on board.
